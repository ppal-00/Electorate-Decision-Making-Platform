...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO candidates (candidate_name, party, criminal_cases, education, age, total_assets, liabilities, constituency, zone)
                VALUES ('$candidate_name', '$party', '$criminal_cases', '$education', '$age', '$total_assets', '$liabilities','$constituency','$zone')";
