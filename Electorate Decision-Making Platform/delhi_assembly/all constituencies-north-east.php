...
// $sql = "SELECT * FROM candidates where constituency='sadar bazar'" ;
$sql = "SELECT * FROM candidates where zone='north-east'" ;
...
<div class='w3-panel w3-leftbar w3-khaki'>
    <h2>All Constituencies-North-East</h2>
</div>
