...
<head>
    ...
    <title>Delhi MCD Elections</title>
...
// $sql = "SELECT * FROM candidatesMCD where constituency='sadar bazar'" ;
$sql = "SELECT * FROM candidatesMCD where zone='south-east'" ;
